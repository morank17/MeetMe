...
extension DeveloperToolsSupport.ImageResource {
    ...
    static let appleIcon = DeveloperToolsSupport.ImageResource(name: "AppleIcon", bundle: resourceBundle)

    /// The "GoogleIcon" asset catalog image resource.
    static let googleIcon = DeveloperToolsSupport.ImageResource(name: "GoogleIcon", bundle: resourceBundle)
